...
COUNTRIES = {
    '':   {'lang':'en',    'hreflang':'en',    'lg':'en', 'kw':'',          'label':'Analytics', 'url':'/analytics/',    'home':'/',     'app':'app-en.v3.js'},
    'ar': {'lang':'es-AR', 'hreflang':'es-AR', 'lg':'es', 'kw':'argentina', 'label':'Análisis',  'url':'/ar/analytics/', 'home':'/ar/', 'app':'app-ar.v3.js'},
    'cl': {'lang':'es-CL', 'hreflang':'es-CL', 'lg':'es', 'kw':'chile',     'label':'Análisis',  'url':'/cl/analytics/', 'home':'/cl/', 'app':'app-cl.v2.js'},
    'co': {'lang':'es-CO', 'hreflang':'es-CO', 'lg':'es', 'kw':'colombia',  'label':'Análisis',  'url':'/co/analytics/', 'home':'/co/', 'app':'app-co.v3.js'},
    'cr': {'lang':'es-CR', 'hreflang':'es-CR', 'lg':'es', 'kw':'costarica', 'label':'Análisis',  'url':'/cr/analytics/', 'home':'/cr/', 'app':'app-cr.v2.js'},
    'mx': {'lang':'es-MX', 'hreflang':'es-MX', 'lg':'es', 'kw':'mexico',    'label':'Análisis',  'url':'/mx/analytics/', 'home':'/mx/', 'app':'app-mx.v3.js'},
    'pa': {'lang':'es-PA', 'hreflang':'es-PA', 'lg':'es', 'kw':'panama',    'label':'Análisis',  'url':'/pa/analytics/', 'home':'/pa/', 'app':'app-pa.v3.js'},
    ...
    'kz': {'lang':'ru-KZ', 'hreflang':'ru-KZ', 'lg':'ru', 'kw':'kazahstan', 'label':'Аналитика', 'url':'/kz/analytics/', 'home':'/kz/', 'app':'app-kz.v3.js'},
    'us': {'lang':'en-US', 'hreflang':'en-US', 'lg':'en', 'kw':'usa',        'label':'Analytics', 'url':'/us/analytics/', 'home':'/us/', 'app':'app-us.v2.js'},
    'ca': {'lang':'en-CA', 'hreflang':'en-CA', 'lg':'en', 'kw':'canada',     'label':'Analytics', 'url':'/ca/analytics/', 'home':'/ca/', 'app':'app-ca.v2.js'},
    'au': {'lang':'en-AU', 'hreflang':'en-AU', 'lg':'en', 'kw':'australia',  'label':'Analytics', 'url':'/au/analytics/', 'home':'/au/', 'app':'app-au.v2.js'},
    'kg': {'lang':'ru-KG', 'hreflang':'ru-KG', 'lg':'ru', 'kw':'kyrgyzstan', 'label':'Аналитика', 'url':'/kg/analytics/', 'home':'/kg/', 'app':'app-kg.v2.js'},
    'uz': {'lang':'ru-UZ', 'hreflang':'ru-UZ', 'lg':'ru', 'kw':'uzbekistan', 'label':'Аналитика', 'url':'/uz/analytics/', 'home':'/uz/', 'app':'app-uz.v2.js'},
    'az': {'lang':'ru-AZ', 'hreflang':'ru-AZ', 'lg':'ru', 'kw':'azerbaijan', 'label':'Аналитика', 'url':'/az/analytics/', 'home':'/az/', 'app':'app-az.v3.js'},
}
